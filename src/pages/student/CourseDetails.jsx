              ...
              <div className="p-6 space-y-6">
                ...
                {isAlreadyEnrolled ? (
                  <Link to="/my-enrollments">
                    <button className="w-full py-3 rounded-xl bg-violet-600 text-white font-medium hover:bg-violet-700 transition">
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl bg-violet-600 text-white font-medium hover:bg-violet-700 transition"
                  >
                    Enroll Now
                  </button>
                )}
