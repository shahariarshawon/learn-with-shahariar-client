	...
	return (
		<footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
			<div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
				...
				<p className="text-white text-2xl font-semibold mb-2">Learn with Shahariar</p>
					
					<p className="mt- text-center sm:flex sm:flex-row sm:justify-center  md:text-left text-sm text-white/80">
						Learn with Shahariar makes education accessible and engaging, connecting
						students with educators through quality courses, interactive tools,
						and intuitive design.
					</p>
				</div>
			...
			<p className="py-4 text-center text-xs md:text-sm text-white/60">
				Copyright 2026 © Learn with Shahariar. All Right Reserved.
			</p>
		</footer>
	);
};
